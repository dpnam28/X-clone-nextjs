...
export default function SignInPage() {
  return (
    <div className="h-screen flex items-center justify-between p-8">
      ...
      <div className="w-full lg:w-2/5 flex flex-col gap-4 max-lg:justify-center max-lg:items-center">
        <h1 className="text-3xl xsm:text-4xl font-bold md:text-6xl">
          Happening now
        </h1>
        ...
        <SignIn.Root>
          ...
          <Clerk.Connection
            name="google"
            className="bg-white rounded-full p-2 text-black w-72 flex justify-center items-center gap-4 cursor-pointer font-bold"
          >
          ...
          <SignIn.Step name="start">
            ...
            <SignIn.Action submit className="clerk-link">
              Continue
            </SignIn.Action>
          </SignIn.Step>
          ...
          <SignIn.Step name="verifications">
            <SignIn.Strategy name="password">
              <Clerk.Field name="password" className="flex flex-col gap-2">
                <Clerk.Input placeholder="password" className="clerk-input" />
                <Clerk.FieldError className="clerk-error" />
              </Clerk.Field>
          ...
          >
            ...
            <SignIn.Action
              navigate="previous"
              className="text-iconBlue underline"
            >
              Go back
            </SignIn.Action>
          </SignIn.Step>
          ...
          <div className="w-72 flex items-center gap-4">
            ...
            <span className="text-grayLight">or</span>
            <div className="h-px bg-borderGray grow"></div>
          </div>
          <Link
            href={"/sign-up"}
            className="bg-iconBlue rounded-full p-2 text-white w-72 flex justify-center items-center gap-4 cursor-pointer font-semibold"
          >
            Create Account
          </Link>
